...
INSERT INTO options(option_id, category, material, name, price) VALUES('AA_Collections2', 'SOFA', 'Wood', 'AA Sofa', 975.00);
INSERT INTO options(option_id, category, material, name, price) VALUES('NISH_Collections2', 'BED', 'Metal', 'Nish Sofa', 700.00);
INSERT INTO options(option_id, category, material, name, price) VALUES('ZURI_Collections', 'BED', 'Fabric', 'Zuri Sofa', 450.00);



INSERT INTO options(option_id, category, material, name, price) VALUES('AA_Collections3', 'CHAIR', 'Wood', 'AA Chair', 600.00);
INSERT INTO options(option_id, category, material, name, price) VALUES('NISH_Collections3', 'CHAIR', 'Metal', 'Nish Chair', 399.00);
